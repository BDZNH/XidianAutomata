...
\noindent{\textbf{惯例 A.4(元组投影)}: 对于$n$-元组 $t=(x_1,x_2,\cdots,x_n)$，我们使用符号${\pi}_i(t) (1 \leq i \leq n)$ 代表元组元素$x_i$；我们使用符号 $\bar{\pi}_i(1 \leq i \leq n)$代表$(n-1)$-$tuple(x_1,\cdots,x_{i-1},x_{i+1},\cdots,x_n)$。$\pi$ 和 $\bar{\pi}$ 自然扩展到元组集。 }
\newline
