...
\begin{figure}[tbp]
    ...
    \resizebox {0.9\textwidth} {!} {
        \begin{tikzpicture}
            ...
            % \node at ( 6,-7.5) [place,label=right:$(\text{4.9})$] (n3) {};
            % \node at ( 6,-10.5) [place,label=right:$(\text{pg. 15})$] (n4) {};
            % \node at ( 0,-6) [place,label=right:$(\text{4.10})$] (n15) {};
            % \node at (-12,-6) [place,label=right:$(\S \text{4.1-4.5})$] (n5) {};
            % \node at (-6,-10.5) [place,label=right:$(\text{Hopcroft-Ullman(4.7)})$] (n6) {};
            % \node at (-18,-10.5) [place,label=right:$(\text{4.2})$] (n7) {};
            % \node at (-12,-10.5) [place] (n8) {};
            % \node at (-16,-13.5) [place,label=right:$(\text{4.3})$] (n9) {};
            % \node at (-16,-16.5) [place,label=right:$(\text{ASU(4.4)})$] (n10) {};
            % \node at (-8,-13.5) [place,label=right:$(\text{4.5})$] (n11) {};
            % \node at (-8,-16.5) [place,label=right:$(\text{4.6})$] (n12) {};
            % \node at (-8,-19.5) [place,label=right:$(\text{pg. 14})$] (n13) {};
            % \node at (-8,-22.5) [place,label=right:$(\text{Hopcroft(4.8)})$] (n14) {};
            % \node at (-18,-0) [place,label=right:$\text{Brzozowski}(\S 2)$] (n16) {};
