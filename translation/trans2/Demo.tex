%!TEX program = xelatex
\documentclass[WordOneHalf,adobe,print]{XDUthesis}   %%启用默认字体设置，word 1.5 倍行距，打印样式
% 参数设置：
%     功能设置：
...
\input{ThesisFiles/section1.tex}
\input{ThesisFiles/section2.tex}
\input{ThesisFiles/section3.tex}
\input{ThesisFiles/section4.tex}
\input{ThesisFiles/conlusion.tex}
